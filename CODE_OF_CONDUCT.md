...
This project follows the Contributor Covenant Code of Conduct (v2.1), which is the template GitHub recommends for open source projects.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by opening an issue at:
...
2. **Warning**  
   A warning with consequences for continued behavior. No interaction with the people involved may be required for a specified period of time.

3. **Temporary Ban**  
   A temporary ban from interacting with the community. No public or private interaction with the people involved is allowed for a specified period of time.
